...
export const mockProducts: Product[] = [
  {
    ...
    price: 450000,
    currency: 'XAF',
    mainImage: 'https://images.unsplash.com/photo-1632661674596-df8be070a5c5?q=80&w=400',
    additionalImages: [
  ...
  },
  {
    ...
    price: 380000,
    currency: 'XAF',
    mainImage: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?q=80&w=400',
    listingTime: {
  ...
  },
  {
    ...
    price: 1200000,
    currency: 'XAF',
    mainImage: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=400',
    additionalImages: [
  ...
  },
  {
    ...
    price: 1500000,
    currency: 'XAF',
    mainImage: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=400',
    listingTime: {
  ...
  },
  {
    ...
    price: 750000,
    currency: 'XAF',
    mainImage: 'https://images.unsplash.com/photo-1593784991095-a205069470b6?q=80&w=400',
    listingTime: {
...
export const mockEmptySlots = Array.from({ length: 25 }, (_, i) => i + 1)
  .filter(slotNumber => !mockProducts.some(product => product.slotNumber === slotNumber)); 