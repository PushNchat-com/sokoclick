...
const mockProduct = {
  ...
  mainImage: 'https://images.unsplash.com/photo-1632661674596-df8be070a5c5?q=80&w=1000',
  additionalImages: [
...
const endingSoonProduct = {
  ...
  price: 380000,
  mainImage: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?q=80&w=1000',
  additionalImages: [],
  listingTime: {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">SokoClick Component Test</h1>
