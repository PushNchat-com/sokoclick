...
const mockProduct: Product = {
  ...
  price: 450000,
  currency: 'XAF',
  mainImage: 'https://images.unsplash.com/photo-1603891128711-11b4b03bb138?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aXBob25lJTIwMTIlMjBwcm98ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
  images: [
    {
  ...
  const handleShare = async () => {
    ...
    try {
      if (navigator.share) {
        ...
        alert(language === 'en' ? 'Link copied to clipboard!' : 'Lien copié dans le presse-papiers !');
      }
    } catch (err) {
    ...
    return (
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <div className="bg-red-50 border border-red-200 text-red-700 p-4 rounded-lg">
          <h2 className="text-lg font-semibold mb-2">{language === 'en' ? 'Error' : 'Erreur'}</h2>
          <p>{error}</p>
          <button 
            onClick={() => navigate('/')} 
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            <div className="text-sm font-medium bg-primary-50 text-primary-700 px-3 py-1 rounded-full border border-primary-200">
              {localizedTexts.slot[language as 'en' | 'fr']} #{product.slotNumber}
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="flex items-center text-sm text-gray-500 mt-1">
                ...
                <span>{product.views} {language === 'en' ? 'views' : 'vues'}</span>
            ...
            <div className="flex flex-col space-y-3">
              <WhatsAppButton
                ...
                buttonText={localizedTexts.contactSeller[language as 'en' | 'fr']}
                variant="large"
                className="w-full"
              />
        ...
        <div className="mt-8 space-y-6">
          ...
          <Card className="bg-white rounded-xl shadow-sm overflow-hidden">
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold mb-4">{localizedTexts.description[language as 'en' | 'fr']}</h2>
            ...
            <Card className="bg-white rounded-xl shadow-sm overflow-hidden">
              <CardContent className="p-6">
                <h2 className="text-xl font-semibold mb-4">
                  {language === 'en' ? 'Admin Actions' : 'Actions d\'administrateur'}
                </h2>
                <div className="flex flex-wrap gap-3">
                  ...
                  <button className="bg-red-600 text-white py-2 px-6 rounded-lg hover:bg-red-700 transition-colors">
                    ...
                    {language === 'en' ? 'Remove Listing' : 'Supprimer l\'annonce'}
                  </button>
                </div>
              </CardContent>
            </Card>
