...
const MainLayout: React.FC<MainLayoutProps> = ({ 
  ...
  const footerText = {
    en: 'A mobile-first ecommerce auction platform with 25 dedicated slots serving the Cameroonian market.',
    fr: 'Une plateforme d\'enchères e-commerce mobile avec 25 emplacements dédiés au service du marché camerounais.'
  };
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex items-center" aria-label="SokoClick Home">
            <img 
              src={logoImage} 
              alt="SokoClick Logo" 
              width="48" 
          ...
          <div className="flex items-center space-x-4">
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-4">
                ...
                >
                  {user?.firstName || user?.name || t(navText.profile)}
                </Link>
                <button
                  onClick={() => signOut()}
                  className="text-sm font-medium text-gray-700 hover:text-indigo-600"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="tel:+237673870377" className="text-sm text-gray-600 hover:text-gray-900 flex items-center">
                ...
                <li>
                  <a href="https://wa.me/237673870377" className="text-sm text-gray-600 hover:text-gray-900 flex items-center">
                    <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="mailto:contact@sokoclick.com" className="text-sm text-gray-600 hover:text-gray-900 flex items-center">
                    <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-500 text-center">
              &copy; {new Date().getFullYear()} SokoClick. {t(allRightsReserved)}
            </p>
          </div>
        </div>
      </footer>
