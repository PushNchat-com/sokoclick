 ...
 */
export function handleServiceError<T>(error: unknown, context: string): ServiceResponse<T> {
 ...
 */
export function validateRequired(data: Record<string, any>, requiredFields: string[]): { 
  isValid: boolean;
