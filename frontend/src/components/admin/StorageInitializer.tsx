...
import { initializeSlotFolders, clearSlotImages, checkSlotFolderExists } from '../../utils/slotStorage';
...
const StorageInitializer: React.FC = () => {
  ...
  const [initializedSlots, setInitializedSlots] = useState<Record<number, boolean>>({});
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="text-sm">
            ...
            {Object.values(initializedSlots).filter(Boolean).length} / 25 {t({
              en: 'folders exist',
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-4 items-center">
          <div>
            <label htmlFor="slotSelect" className="block text-sm font-medium text-gray-700 mb-1">
              {t({
                en: 'Select Slot:',
