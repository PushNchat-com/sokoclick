  ...
  return (
    <footer className="bg-gray-900 text-white">
      <Container className="py-12 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-8 border-b border-gray-800">
          <div>
            <Link to="/" className="flex items-center">
              <Logo variant="white" />
            </Link>
            <Text variant="body-sm" className="mt-3 text-gray-400">
              The premier platform for exclusive auctions with direct seller contact through WhatsApp.
            </Text>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-gray-400">
                ...
                <span>{t('whatsappIntegration')}</span>
              </li>
              <li className="flex items-center text-gray-400">
                <svg className="h-5 w-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <Text variant="body-sm" className="mt-8 md:mt-0 text-center md:text-left text-gray-400">
            &copy; {currentYear} SokoClick. {t('allRightsReserved')}
          </Text>
        </div>
      </Container>
    </footer>
