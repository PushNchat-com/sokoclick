...
import {
  useSlots,
  getAvailableSlotsForProductForm,
} from "../../services/slots";
...
const BaseProductForm: React.FC<BaseProductFormProps> = ({
  ...
  const text = {
    ...
    loading: {
      en: "Loading product data...",
      fr: "Chargement des données du produit...",
    },
    confirmCancel: {
      en: "Cancel product creation?",
      fr: "Annuler la création du produit?",
    },
