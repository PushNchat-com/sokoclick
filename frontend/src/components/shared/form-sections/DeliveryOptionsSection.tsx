...
const DeliveryOptionsSection: React.FC<DeliveryOptionsSectionProps> = ({
  ...
  const text = {
    ...
    deliveryNameEn: {
      en: "Delivery Name (English)",
      fr: "Nom de livraison (Anglais)",
    },
    deliveryNameFr: {
      en: "Delivery Name (French)",
      fr: "Nom de livraison (Français)",
    },
    ...
    deliveryDays: {
      en: "Estimated Delivery Days",
      fr: "Jours de livraison estimés",
    },
    deliveryFee: { en: "Delivery Fee", fr: "Frais de livraison" },
    addDeliveryOption: {
      en: "Add Delivery Option",
      fr: "Ajouter une option de livraison",
    },
  ...
  const handleOptionChange = (
    index: number,
    field: keyof DeliveryOptionInternal,
    value: any,
  ) => {
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleOptionChange(index, "name_en", e.target.value)
                  }
                  placeholder={t({
                    en: "e.g. Standard Delivery",
                    fr: "ex. Livraison Standard",
                  })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleOptionChange(index, "name_fr", e.target.value)
                  }
                  placeholder={t({
                    en: "e.g. Livraison Standard",
                    fr: "ex. Livraison Standard",
                  })}
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {t(text.deliveryAreas)}{" "}
                  <span className="text-gray-500 text-xs">
                    ({t(text.separateWithCommas)})
                  </span>
                </label>
                <input
                  type="text"
                  ...
                  placeholder={t({
                    en: "e.g. Douala, Yaoundé",
                    fr: "ex. Douala, Yaoundé",
                  })}
