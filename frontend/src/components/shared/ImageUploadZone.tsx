...
const ImageUploadZone: React.FC<ImageUploadZoneProps> = ({
  ...
  const handleRemoveImage = (index: number) => {
    ...
    if (
      ...
      newImages[index].previewUrl.startsWith("blob:")
    ) {
  ...
  return (
    <div
      ...
      role="region"
      aria-label={t({ en: "Product Images", fr: "Images du produit" })}
    >
      {/* Image previews */}
      <div
            ...
            {image.url || image.previewUrl ? (
              <>
                ...
                <button
                  ...
                  aria-label={t({
                    en: `Remove image ${index + 1}`,
                    fr: `Supprimer l'image ${index + 1}`,
                  })}
                >
                  <svg
                    className="w-4 h-4"
        ...
        {images.length < maxImages && (
          <div
            ...
            aria-label={t({
              ...
              fr: "Ajouter une image de produit",
            })}
