...
const ProductDetails: React.FC<ProductDetailsProps> = ({
  ...
  const displayDescription =
    isRTL && description.ar ? description.ar : description.en;
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent(
      `Hello, I'm interested in your product: ${title.en}`,
    );
          ...
          <div>
            ...
            <div className="flex items-center text-sm text-gray-500 mt-2 gap-4">
              <div className="flex items-center">
                ...
                <span>
                  {isRTL ? "الحالة:" : "Condition:"} {condition}
                </span>
              </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3 flex-1">
                ...
                <div className="flex items-center text-sm text-gray-500 mt-1">
                  ...
                  <div>
                    <span>
                      {isRTL ? "عضو منذ" : "Member since"} {seller.joinDate}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-500 mb-2">
                {isRTL
                  ? `${seller.totalSales} عمليات بيع مكتملة`
                  : `${seller.totalSales} completed sales`}
              </p>
              <button
