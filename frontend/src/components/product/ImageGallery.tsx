...
const ImageGallery: React.FC<ImageGalleryProps> = ({
  ...
  if (!images || images.length === 0) {
    return (
      <div
        className={`relative w-full aspect-square bg-gray-200 rounded-lg ${className}`}
      >
    ...
    <div className={`${className}`}>
      ...
      >
        <div className="relative w-full h-full">
          ...
          <picture>
            <source
              srcSet={getWebpUrl(images[currentIndex].url)}
              type="image/webp"
            />
            ...
            <img
              ...
              alt={
                images[currentIndex].alt || `Product image ${currentIndex + 1}`
              }
