...
const ProductCardSkeleton: React.FC<ProductCardSkeletonProps> = ({ className }) => {
  return (
    <div 
      className={twMerge(
        "bg-white border border-gray-200 rounded-md overflow-hidden shadow-sm hover:shadow-md transition-shadow",
        className
      )}
    >
      {/* Image area */}
 ...
 */
export const ProductCardGridSkeleton: React.FC<{ count?: number; className?: string }> = ({ 
  count = 8,
  className 
}) => {
  return (
