...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  if (variant === "default") {
    variantStyles =
      "px-4 py-2 text-sm gap-2 min-h-[44px] min-w-[44px] rounded-md";
  } else if (variant === "large") {
    variantStyles =
      "px-6 py-3 text-base gap-3 min-h-[50px] min-w-[50px] rounded-md";
  } else if (variant === "corner") {
    variantStyles =
      "px-4 py-2 text-sm rounded-tl-btn rounded-br-none rounded-tr-none rounded-bl-none";
  }
